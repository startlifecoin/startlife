StartLife Core version 2.2.1 is now available from:

  <https://github.com/startlife-project/startlife/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/startlife-project/startlife/issues>

Compatibility
==============

StartLife Core is extensively tested on multiple operating systems using
...
StartLife Core should also work on most other Unix-like systems but is not
...
of Bitcoin that StartLife was forked from.
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/startlife-project-translations/).
