...
In order to support loading of multiple wallets in startlife-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is startlife.cpp.
...
Changes to startlife.cpp
----------------------
startlife.cpp is the entry point into startlife-qt, and as such, will require some minor modifications to provide hooks for
