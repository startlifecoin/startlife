...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("StartLife Core startlife-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  startlife-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded startlife transaction") + "\n" +
                               "  startlife-tx [options] -create [commands]   " + _("Create hex-encoded startlife transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded startlife transaction
