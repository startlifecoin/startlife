...
#if defined(NDEBUG)
#error "StartLife cannot be compiled without assertions."
#endif
...
int64_t GetBlockValue(int nHeight)
{
	...
	if (nHeight == 0) {
      ...
      } else if (nHeight <= 130 && nHeight > 0) {
        nSubsidy = 0 * COIN;
	} else if (nHeight <= 1000 && nHeight > 130) {
	      nSubsidy = 1 * COIN;
} else if (nHeight <= 3500 && nHeight > 1000) {
        nSubsidy = 0.6 * COIN;

    } else if (nHeight <= 4000 && nHeight > 3500) {
              nSubsidy = 0.7 * COIN;

    } else if (nHeight <= 10000 && nHeight > 4000) {
                    nSubsidy = 0.8 * COIN;
        ...
        nSubsidy = 2 * COIN;
            ...
            nSubsidy = 2.5 * COIN;
	} else if (nHeight <= 300000 && nHeight > 160000) {
        nSubsidy = 1.6 * COIN;
	} else if (nHeight <= 7439033 && nHeight > 300000) {
        nSubsidy = 1.5 * COIN;
    } else {
        nSubsidy = 0 * COIN;
    }
...
{
    RenameThread("startlife-scriptch");
