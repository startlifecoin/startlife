                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("StartLife Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a StartLife address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and startlife: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About StartLife Core"), this);
    aboutAction->setStatusTip(tr("Show information about StartLife Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for StartLife"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your StartLife addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified StartLife addresses"));
    ...
    openAction->setStatusTip(tr("Open a StartLife: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the StartLife Core help message to get a list with possible StartLife command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("StartLife Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to StartLife network", "", count));
}
...
{
    QString strTitle = tr("StartLife Core"); // default title
