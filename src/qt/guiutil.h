...
/** Utility functions used by the StartLife Qt UI.
 */
namespace GUIUtil
{
...
// Render StartLife addresses in monospace font
...
// Parse "startlife:" URI into recipient object, return true on successful parsing
