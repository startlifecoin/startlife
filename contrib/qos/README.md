...
This means one can have an always-on startlifed instance running, and another local startlifed/startlife-qt instance which connects to this node and receives blocks from it.
