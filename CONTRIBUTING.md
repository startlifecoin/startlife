Contributing to StartLife Core
============================

The StartLife Core project operates an open contributor model where anyone is
...
The following applies to code changes to the StartLife Core project, and is not to be
confused with overall StartLife Network Protocol consensus changes.

Whether a pull request is merged into StartLife Core rests with the project merge
...
Patches that change StartLife consensus rules are considerably more involved than
...
Where a patch set proposes to change the StartLife consensus, it must have been
...
The project leader is the release manager for each StartLife Core release.
